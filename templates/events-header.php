...
<h2 class="event-page-title">
	...
	<p class="event-sub-head">
			...
			<?php elseif ( current_user_can( 'manage_translation_event_attendees', $event->id() ) ) : ?>
				<a class="event-page-attendees-link" href="<?php echo esc_url( Urls::event_attendees( $event->slug() ) ); ?>"><?php esc_html_e( 'Manage attendees', 'gp-translation-events' ); ?></a>
			<?php endif ?>
		</p>
		<?php endif; ?>
