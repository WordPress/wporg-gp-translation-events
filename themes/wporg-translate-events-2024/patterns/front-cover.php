...
<a class="blue-bolded-link" href="/events/">Host an event</a>
<p class="has-charcoal-0-color has-text-color has-link-color ">Create your own translation event.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<a class="wp-block-heading has-inter-font-family blue-bolded-link" href="/events/">My events</a>
<p class="has-charcoal-0-color has-text-color has-link-color">Manage events you’ve created, or pledged to attend.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
