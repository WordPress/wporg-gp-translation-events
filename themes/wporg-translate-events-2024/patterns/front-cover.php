...
<h4 class="wp-block-heading has-inter-font-family has-medium-font-size" style="font-style:normal;font-weight:700"><?php echo esc_html__( 'Get involved', 'wporg-translate-events-2024' ); ?></h4>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Start your journey to contribute to localization.', 'wporg-translate-events-2024' ); ?></p>
<!-- /wp:paragraph -->
...
<a class="blue-bolded-link" href="<?php echo esc_url( $host_event_url ); ?>"><?php echo esc_html__( 'Host an event', 'wporg-translate-events-2024' ); ?></a>
<p class="has-charcoal-0-color has-text-color has-link-color "><?php echo esc_html__( 'Create your own translation event.', 'wporg-translate-events-2024' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<a class="wp-block-heading has-inter-font-family blue-bolded-link" href="<?php echo esc_url( Urls::my_events() ); ?>"><?php echo esc_html__( 'My events', 'wporg-translate-events-2024' ); ?></a>
<p class="has-charcoal-0-color has-text-color has-link-color"><?php echo esc_html__( 'Manage events you’ve created, or pledged to attend.', 'wporg-translate-events-2024' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
